...
| Test suite | 2072 lines (`wc -l tests/*.py`), 139 tests collected: 138 passed + 1 skipped (the credit-gated judge test) — as of 2026-09-24 | `python -m pytest tests/ --collect-only`; `python -m pytest tests/` |
